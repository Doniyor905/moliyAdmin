				...
				<div className={classes['header__inner']}>
					<div className={classes['header__logo']}>
						...
						<FontAwesomeIcon
							...
							className={classes['header__logo-bar']}
							icon={faBars}
						/>
					</div>
					<div className={classes['header__settings']}>
						<div
							onClick={() => setHeaderProfile(!headerProfile)}
							className={classes['header__settings-item']}>
						...
						<div
							className={
								headerProfile
									? classNames(classes['header__settings-dropdown'], classes['active'])
									: classes['header__settings-dropdown']
							}>
							...
							<ul>
								<li className={classes['header__settings-profile']}>
									<Link to="/myProfile">
										<FontAwesomeIcon
											icon={faUser}
											className={classes['header__settings-profile-icon']}
										/>
										<p>My profile</p>
									</Link>
								</li>
								<li className={classes['header__settings-signOut']}>
									<a href="#!">
										<FontAwesomeIcon
											icon={faSignOutAlt}
											className={classes['header__settings-signOut-icon']}
										/>
										<p>Sign out</p>
									</a>
								</li>
